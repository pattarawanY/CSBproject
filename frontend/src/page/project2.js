    ...
    useEffect(() => {
        const fetchProjects = async () => {
            try {
                ...
                // กรองเฉพาะ project ที่มีข้อมูลใน project1
                const filteredProjects = res.data.filter(p => {
                    const pj1 = project1Obj[p.p_ID];
                    return pj1 && (
                        pj1.mentorStatus !== undefined ||
                        pj1.docStatus !== undefined ||
                        pj1.gradePj1 !== undefined ||
                        pj1.yearPj1 !== undefined
                    );
                });
